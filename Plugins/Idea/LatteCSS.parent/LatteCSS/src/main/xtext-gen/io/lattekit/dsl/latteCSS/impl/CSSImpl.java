 ...
 * </p>
 * <ul>
 *   <li>{@link io.lattekit.dsl.latteCSS.impl.CSSImpl#getDefinitions <em>Definitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CSSImpl extends MinimalEObjectImpl.Container implements CSS
{
  ...
  {
    return LatteCSSPackage.Literals.CSS;
  }
  ...
  public EList<Definition> getDefinitions()
  {
    if (definitions == null)
    {
      definitions = new EObjectContainmentEList<Definition>(Definition.class, this, LatteCSSPackage.CSS__DEFINITIONS);
    }
    return definitions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LatteCSSPackage.CSS__DEFINITIONS:
